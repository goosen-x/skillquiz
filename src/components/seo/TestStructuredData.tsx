...
export function TestStructuredData({ test }: TestStructuredDataProps) {
  const structuredData = {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://psytest.ru/logo.png"
      }
    },
    "applicationSubCategory": test.category === 'psychology' ? 'Психологический тест' : 
                            test.category === 'career' ? 'Карьерный тест' : 'Тест образа жизни',
    "featureList": [
    ...
    "screenshot": `https://psytest.ru/images/tests/${test.slug}-screenshot.jpg`,
    "softwareVersion": "1.0",
