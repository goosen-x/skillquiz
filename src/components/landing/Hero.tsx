...
export function Hero() {
  ...
  return (
    <section className="relative bg-background min-h-screen overflow-hidden">
      ...
      />
      <motion.div
        className="absolute w-32 h-32 border-2 border-border bg-chart-2"
      ...
      />
      <motion.div
        className="absolute w-24 h-24 border-2 border-border bg-chart-3 rounded-full"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24">
        ...
        >
          ...
          >
            <span className="text-main">Психологические</span>{' '}
          ...
          >
            Узнай свой <strong className="font-bold">тип личности</strong>, найди подходящую <strong className="font-bold">профессию</strong> и раскрой потенциал с научными тестами
          </motion.h2>
          ...
          >
            <Link href="/tests">
              <Button
                size="lg" 
                className="uppercase font-bold text-lg px-8 py-6"
              >
