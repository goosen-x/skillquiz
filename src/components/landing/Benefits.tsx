  ...
  const benefits = [
    {
      ...
      title: 'Самопознание',
      description:
        'Глубокое понимание своего характера, темперамента и психологических особенностей для личностного роста',
    ...
    },
    {
      ...
      description:
        'Научно обоснованные рекомендации по выбору профессии на основе ваших интересов и способностей',
    ...
    },
    {
      ...
      description:
        'Быстрые тесты за 5-15 минут с мгновенными результатами и подробной расшифровкой',
    ...
    },
    {
      ...
      description:
        'Все тесты основаны на проверенных психологических методиках и научных исследованиях',
    ...
    },
    {
      ...
      description:
        'Выявление скрытых талантов и возможностей для максимального раскрытия своих способностей',
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {benefit.keywords.map((keyword, keyIndex) => (
                            <NeoBadge key={keyIndex} className="text-xs">
                              {keyword}
                            </NeoBadge>
                          ))}
                        </div>
          ...
          <NeoCard className="bg-main">
            <NeoCardContent className="p-8 text-center">
              ...
              <p className="text-main-foreground leading-relaxed max-w-4xl mx-auto font-base">
                Понимание своего <strong className="font-bold">типа личности</strong> помогает
                принимать правильные решения в карьере, отношениях и саморазвитии. Наши{' '}
                <strong className="font-bold">психологические тесты</strong> основаны на научных
                методиках и помогают тысячам людей найти свой путь. Пройдите
                <strong className="font-bold"> тест на личность бесплатно</strong> и получите
                персональные рекомендации от профессиональных психологов.
              </p>
            </NeoCardContent>
          </NeoCard>
        </motion.div>
