...
export const calculateTimeManagementResult = (
  ...
  if (totalScore <= 25) {
    ...
    description =
      'У вас низкий уровень навыков управления временем. Отсутствие планирования и системы приоритетов создает хаос и снижает продуктивность. Необходимо кардинально пересмотреть подход к организации времени.';
    ...
    description =
      'Ваши навыки управления временем находятся в процессе развития. Вы понимаете важность планирования, но не всегда применяете это на практике. С небольшими усилиями можете значительно улучшить свою эффективность.';
    strengths = [
    ...
    description =
      'У вас хорошие навыки управления временем. Вы планируете свою деятельность, умеете расставлять приоритеты и в основном справляетесь с задачами в срок. Есть возможности для дальнейшего совершенствования.';
    strengths = [
    ...
    description =
      'У вас превосходные навыки управления временем. Вы мастерски планируете, эффективно расставляете приоритеты и оптимально используете каждую минуту. Ваши навыки могут служить примером для других.';
    strengths = [
  ...
  if (level === 'poor') {
    ...
    recommendations.push('Поделитесь опытом с другими', 'Станьте ментором по продуктивности');
  }
