...
export const calculateDecisionMakingResult = (answers: Record<string, number>): DecisionMakingResult => {
  const scores = {
    analytical: 0,
    intuitive: 0,
    directive: 0,
  ...
  decisionMakingQuestions.forEach((question, index) => {
  ...
  switch (primary_style) {
    case 'analytical':
      ...
      description = 'Вы предпочитаете тщательно анализировать информацию перед принятием решений. Ваш подход основан на логике, фактах и систематическом изучении всех доступных данных. Вы стремитесь к объективности и рациональности в процессе выбора.';
      characteristics = [
    ...
    case 'intuitive':
      ...
      description = 'Вы полагаетесь на интуицию, эмоции и внутренние ощущения при принятии решений. Ваш подход основан на накопленном опыте, эмоциональном интеллекте и способности "чувствовать" правильные решения.';
      characteristics = [
    ...
    case 'directive':
      ...
      description = 'Вы предпочитаете быстрые, четкие и практичные решения. Ваш подход ориентирован на эффективность, результат и немедленное действие. Вы способны принимать решения в условиях ограниченной информации.';
      characteristics = [
    ...
    case 'conceptual':
      ...
      description = 'Вы склонны к творческому и долгосрочному подходу к принятию решений. Ваш стиль характеризуется поиском инновационных решений, учетом множества альтернатив и стремлением к совершенству.';
      characteristics = [
