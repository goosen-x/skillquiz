...
export const calculateCreativityResult = (answers: Record<string, number>): CreativityResult => {
  ...
  const maxCategory = Object.entries(category_scores).reduce(
    (max, [key, value]) =>
  ...
  if (total_score <= 35) {
    ...
    description =
      'У вас есть основа для развития творческих способностей. Хотя сейчас вы склонны к более традиционным подходам, с практикой и открытостью новому опыту ваша креативность может значительно возрасти.';
    strengths = [
      'Логическое мышление',
      'Практический подход',
    ...
    description =
      'Вы обладаете хорошими творческими способностями и способны находить оригинальные решения. Ваша креативность проявляется в определенных ситуациях, и с развитием она может стать еще более выраженной.';
    strengths = [
    ...
    description =
      'У вас ярко выраженные творческие способности. Вы естественно генерируете оригинальные идеи, любите экспериментировать и не боитесь нестандартных решений. Ваша креативность является значительным преимуществом в жизни и работе.';
    strengths = [
      'Богатое воображение',
    ...
    description =
      'Вы обладаете выдающимися творческими способностями. Ваше мышление отличается высокой оригинальностью, вы постоянно генерируете инновационные идеи и способны кардинально переосмыслить привычные подходы. Ваша креативность может быть источником значительных достижений.';
    strengths = [
