...
export const calculateEntrepreneurshipResult = (
  ...
  if (total_score <= 44) {
    ...
    description =
      'Предпринимательство может не быть вашей естественной склонностью. Вы цените стабильность и предсказуемость. Это не означает, что вы не можете стать предпринимателем, но потребуется значительное развитие навыков и изменение мышления.';
    strengths = [
    ...
    description =
      'У вас есть некоторые предпринимательские качества, но они нуждаются в развитии. С правильным обучением и поддержкой вы можете стать успешным предпринимателем в определенных областях.';
    strengths = [
    ...
    description =
      'У вас хорошие базовые предпринимательские качества. С дополнительным развитием навыков и опыта вы можете создать успешный бизнес в различных областях.';
    strengths = [
    ...
    warning_signs = ['Остановка в развитии', 'Избегание больших возможностей'];
  } else if (total_score <= 99) {
    overall_level = 'above_average';
    title = 'Выше среднего предпринимательский потенциал';
    description =
      'У вас сильный предпринимательский потенциал. Вы обладаете большинством ключевых качеств успешного предпринимателя и можете создать процветающий бизнес в различных сферах.';
    strengths = [
    ...
    description =
      'У вас исключительный предпринимательский потенциал. Вы обладаете всеми ключевыми качествами успешного предпринимателя и можете создать революционные компании и продукты.';
    strengths = [
