...
export const calculateWorkMotivationResult = (
  answers: Record<string, number>
): WorkMotivationResult => {
  const scores = {
    financial: 0,
    recognition: 0,
    autonomy: 0,
  ...
  switch (primary_motivation) {
    case 'financial':
      ...
      description =
        'Вас в первую очередь мотивируют финансовые стимулы: зарплата, бонусы, льготы и материальные поощрения. Вы рассматриваете работу как способ достижения финансового благополучия и безопасности.';
      characteristics = [
    ...
    case 'recognition':
      ...
      description =
        'Вас мотивирует общественное признание ваших достижений, статус и уважение коллег. Важно, чтобы ваши успехи были замечены и оценены другими.';
      characteristics = [
    ...
    case 'autonomy':
      ...
      description =
        'Вас мотивирует свобода и независимость в работе. Вы цените возможность самостоятельно принимать решения и контролировать свой рабочий процесс.';
      characteristics = [
    ...
    case 'purpose':
      ...
      description =
        'Вас мотивирует возможность делать значимую работу, которая приносит пользу обществу и соответствует вашим ценностям. Важен смысл и цель деятельности.';
      characteristics = [
    ...
    case 'growth':
      ...
      description =
        'Вас мотивируют возможности обучения, развития навыков и карьерного роста. Важно постоянно совершенствоваться и осваивать новые компетенции.';
      characteristics = [
    ...
    case 'social':
      ...
      description =
        'Вас мотивируют отношения с коллегами, командная работа и социальное взаимодействие. Важна атмосфера в коллективе и качество рабочих отношений.';
      characteristics = [
    ...
    case 'security':
      ...
      description =
        'Вас мотивирует стабильность, безопасность и предсказуемость в работе. Важны гарантии занятости и стабильные условия труда.';
      characteristics = [
    ...
    case 'achievement':
      ...
      description =
        'Вас мотивируют вызовы, соревнование и возможность достичь выдающихся результатов. Важно быть лучшим и превосходить ожидания.';
      characteristics = [
