...
export const calculateMemoryTypeResult = (answers: Record<string, number>): MemoryTypeResult => {
  ...
  switch (primary_type) {
    case 'visual':
      ...
      description =
        'Вы лучше всего запоминаете информацию через зрительные образы. Диаграммы, схемы, цвета, картинки и пространственное расположение объектов помогают вам эффективно сохранять и воспроизводить информацию.';
      characteristics = [
    ...
    case 'auditory':
      ...
      description =
        'Вы эффективно запоминаете информацию через слух. Лекции, аудиозаписи, музыка и устные объяснения являются для вас наиболее продуктивными способами усвоения и сохранения информации.';
      characteristics = [
    ...
    case 'kinesthetic':
      ...
      description =
        'Вы лучше всего запоминаете через физические действия и движения. Практические упражнения, моторные навыки и тактильные ощущения являются ключом к эффективному запоминанию и воспроизведению информации.';
      characteristics = [
    ...
    case 'logical':
      ...
      description =
        'Вы эффективно запоминаете информацию через понимание логических связей и структур. Систематизация, анализ закономерностей и понимание причинно-следственных связей помогают вам лучше усваивать материал.';
      characteristics = [
