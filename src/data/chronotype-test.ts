...
export const calculateChronotypeResult = (answers: Record<string, number>): ChronotypeResult => {
  ...
  if (totalScore >= 25) {
    ...
    description = 'Вы - ярко выраженный жаворонок. Ваши биологические часы настроены на раннее пробуждение и активность в утренние часы. Вы максимально продуктивны в первой половине дня и естественно засыпаете рано вечером.';
    optimal_schedule = {
      wake_time: '5:00-6:00',
    ...
    description = 'Вы - умеренный жаворонок. У вас есть склонность к утренней активности, но вы более гибки в своем расписании, чем выраженные жаворонки. Вы можете адаптироваться к различным режимам дня.';
    optimal_schedule = {
      wake_time: '6:00-7:00',
    ...
    famous_people = ['Барак Обама', 'Опра Уинфри', 'Джефф Безос', 'Шерил Сэндберг', 'Уоррен Баффетт'];
  } else if (totalScore >= -10) {
    type = 'intermediate';
    title = 'Промежуточный тип';
    description = 'Вы - промежуточный тип или "голубь". У вас сбалансированные биоритмы, и вы можете быть продуктивны как утром, так и вечером. Это самый распространенный хронотип.';
    optimal_schedule = {
      wake_time: '7:00-8:00',
    ...
    famous_people = ['Билл Гейтс', 'Стив Возняк', 'Марк Кьюбан', 'Ариана Хаффингтон', 'Ричард Брэнсон'];
  } else if (totalScore >= -25) {
    type = 'moderate_owl';
    title = 'Умеренная сова';
    description = 'Вы - умеренная сова. Вы предпочитаете более позднее время для активности и лучше всего функционируете во второй половине дня и вечером. При этом вы можете адаптироваться к утренним обязательствам.';
    optimal_schedule = {
      wake_time: '8:00-9:00',
    ...
    famous_people = ['Элон Маск', 'Марк Цукерберг', 'Джеймс Джойс', 'Чарльз Дарвин', 'Владимир Путин'];
  } else {
    type = 'extreme_owl';
    title = 'Выраженная сова';
    description = 'Вы - ярко выраженная сова. Ваши биологические часы сдвинуты к вечернему и ночному времени. Вы наиболее продуктивны поздно вечером и ночью, а утренние часы даются вам с большим трудом.';
    optimal_schedule = {
    ...
    famous_people = ['Уинстон Черчилль', 'Барак Обама', 'Дарвин', 'Хантер С. Томпсон', 'Кит Ричардс'];
  }
