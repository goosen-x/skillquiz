...
export const calculateSelfEsteemResult = (answers: Record<string, number>): SelfEsteemResult => {
  ...
  if (totalScore <= 35) {
    ...
    description = 'У вас очень низкая самооценка. Вы склонны крайне негативно оценивать себя и свои способности. Это может серьезно влиять на все сферы жизни. Рекомендуется обратиться к психологу для работы с самооценкой.';
    characteristics = [
    ...
    description = 'У вас низкая самооценка. Вы часто сомневаетесь в себе и недооцениваете свои способности. Работа над самооценкой поможет вам раскрыть свой потенциал и улучшить качество жизни.';
    characteristics = [
    ...
    description = 'У вас умеренная самооценка. Вы в целом адекватно оцениваете себя, но иногда склонны к сомнениям. Небольшая работа над собой поможет укрепить уверенность в себе.';
    characteristics = [
    ...
    description = 'У вас здоровая самооценка. Вы адекватно оцениваете свои способности, принимаете себя и готовы к развитию. Это отличная основа для успешной и счастливой жизни.';
    characteristics = [
    ...
    challenges = [
      'Поддержание баланса при успехах и неудачах',
      'Избежание самоуспокоенности'
    ];
    development_areas = [
    ...
    description = 'У вас очень высокая самооценка. Важно следить, чтобы она не переросла в нарциссизм. Здоровая высокая самооценка - это уверенность в себе при сохранении способности к самокритике и развитию.';
    characteristics = [
