...
export const calculateManagementStyleResult = (
  answers: Record<string, number>
): ManagementStyleResult => {
  const scores = {
    autocratic: 0,
    democratic: 0,
    transformational: 0,
  ...
  switch (primary_style) {
    case 'autocratic':
      ...
      description =
        'Вы предпочитаете централизованное принятие решений и четкий контроль. Ваш стиль эффективен в ситуациях, требующих быстрых решений и четкого руководства, особенно в кризисных или структурированных средах.';
      characteristics = [
    ...
    case 'democratic':
      ...
      description =
        'Вы цените коллективное принятие решений и активно вовлекаете команду в управленческие процессы. Ваш подход способствует высокой мотивации и вовлеченности сотрудников.';
      characteristics = [
    ...
    case 'transformational':
      ...
      description =
        'Вы вдохновляете команду на достижение выдающихся результатов через создание привлекательного видения будущего. Ваш стиль способствует инновациям и превосходству.';
      characteristics = [
    ...
    case 'servant':
      ...
      description =
        'Вы ставите потребности команды на первое место и фокусируетесь на служении сотрудникам. Ваш подход создает среду доверия и взаимной поддержки.';
      characteristics = [
        'Служение команде',
        'Эмпатия и поддержка',
    ...
    case 'coaching':
      ...
      description =
        'Вы фокусируетесь на развитии потенциала каждого сотрудника через вопросы, обратную связь и поддержку самостоятельного обучения. Ваш стиль способствует росту и самостоятельности.';
      characteristics = [
        'Развитие потенциала',
    ...
    case 'laissez_faire':
      ...
      description =
        'Вы предоставляете команде максимальную свободу и минимально вмешиваетесь в рабочие процессы. Ваш стиль эффективен с высококвалифицированными и самомотивированными командами.';
      characteristics = [
  ...
  const decision_approach =
    primary_style === 'autocratic'
